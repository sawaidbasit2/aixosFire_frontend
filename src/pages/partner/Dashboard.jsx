...
const StatCard = ({ icon: Icon, title, value, color, subtitle }) => {
    return (
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-soft hover:shadow-lg transition-all duration-300 group cursor-pointer overflow-hidden relative">
    ...
    return (
        <div className="min-h-screen pb-20 px-4 md:px-6 animate-in fade-in duration-700">
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-soft-xl overflow-hidden">
                <div className="p-6 md:p-8 border-b border-slate-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                    ...
                    <div className="relative w-full md:w-72">
                        ...
                        <select
                            ...
                            className="w-full pl-12 pr-10 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-medium text-slate-700 outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all appearance-none cursor-pointer"
                        >
                            ...
                            {inquiries.map((inq) => (
                                <tr key={inq.id} className="hover:bg-slate-50/50 transition-colors group">
                                    ...
                                    <td className="px-8 py-6 text-right">
                                        <Link
                                            to={`/partner/inquiry/${inq.id}`}
                                            className="px-6 py-2.5 bg-slate-900 text-white hover:bg-primary-600 rounded-2xl text-xs font-black uppercase tracking-widest transition-all inline-block"
                                        >
                                            View Details
                                        </Link>
                                    </td>
